...
import { CurrencyAmount, Price, Token, TokenAmount, JSBI, ETHER } from '@memeswap/sdk'
...
export default function useGasOverhead(
  ...
  const inputIsBNB = inputAmount?.currency.symbol === 'VLX' || inputAmount?.currency.symbol === 'MON'
