...
export const BASE_URL = `https://exchange.wagyuswap.xyz`
export const BASE_ADD_LIQUIDITY_URL = `${BASE_URL}/add`
// Use Monad explorer as default
export const BASE_VELAS_SCAN_URL = BASE_VELAS_SCAN_URLS[MONAD_CHAIN_ID] || BASE_VELAS_SCAN_URLS[ChainId.MAINNET]
