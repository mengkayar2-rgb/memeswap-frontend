...
export const VLX_WAG_FARM_PID = chainId === MAINNET ? 1 : chainId === MONAD ? 0 : 9 // WAG-VLX (2)
export const VLX_USDT_FARM_PID = chainId === MAINNET ? 5 : chainId === MONAD ? 0 : 6 // BUSD-VLX (3)

// Monad farms - empty for now (farms disabled)
const monadFarms: SerializedFarmConfig[] = []
