...
// For Monad, use a placeholder token since farms are disabled
// For other chains, use the LP token from farms[1]
export const wagVlxLpToken = chainId === MONAD
  ? new Token(chainId, addresses[143].WAGToken, 18, 'MMF', 'MMF Token')
  : farms[1] && farms[1].lpAddresses[chainId]
    ? new Token(chainId, farms[1].lpAddresses[chainId], 18, farms[1].lpSymbol)
    : new Token(chainId, '0x0000000000000000000000000000000000000000', 18, 'LP', 'LP Token')
...
const ifos: Ifo[] = [
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmXwoYYd8rkahVbxiGKsTa4rYRRFWPxhRGAHy3hVwK3Q2z',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmTfN1SKnFidF6XCDcpga7zAf69mFfhb26Zy9b85dYskxW',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmRhc4oC73jk4zxU4YkP1kudKHeq6qamgYA1sWoh6XJnks',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmQqpknHvuQwshVP259qFxfQsxiWbQ9SLMebohDeRwRzKg',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmUqRxjwZCWeZWEdgV2vHJ6hex7jMW7i247NKFas73xc8j',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmaakXYpydAwCgTuSPe3R2ZNraRtkCbK6iBRqBCCdzqKEG',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmeJenHcbY45eQxLRebzvpNk5qSCrj2wM1t4EAMHotFoJL',
  ...
  },
  {
    ...
    articleUrl: 'https://exchange.wagyuswap.xyz/voting/proposal/QmTRWdW9a65fAkyJy1wrAJRU548fNMAZhRUDrSxzMDLmwk',
