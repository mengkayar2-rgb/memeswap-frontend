...
export interface NftMarketInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "WVLX", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "WVLX", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "addCollection",
    data: BytesLike
  ): Result;
...
export interface NftMarket extends BaseContract {
  ...
  functions: {
    ...
    WVLX(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    WVLX(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    WVLX(overrides?: CallOverrides): Promise<PopulatedTransaction>;
