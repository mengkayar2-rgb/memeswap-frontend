...
import type { WAGFarm, WAGFarmInterface } from "../WAGFarm";
    ...
    outputs: [
      {
        ...
        internalType: "struct WAGFarmV2.PoolInfo",
        name: "pool",
        type: "tuple",
      },
    ],
...
export class WAGFarm__factory {
  static readonly abi = _abi;
  static createInterface(): WAGFarmInterface {
    return new utils.Interface(_abi) as WAGFarmInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WAGFarm {
    return new Contract(address, _abi, signerOrProvider) as WAGFarm;
  }
}
