...
export interface WAGStakingPoolInitializableInterface extends utils.Interface {
  functions: {
    "PRECISION_FACTOR()": FunctionFragment;
    "SOUS_CHEF_FACTORY()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "SOUS_CHEF_FACTORY",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "NewrewardPerSecond(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewrewardPerSecond"): EventFragment;
...
export type NewStartAndEndBlocksEvent = TypedEvent<
  [BigNumber, BigNumber],
  { startTimestamp: BigNumber; endBlock: BigNumber }
>;

export type NewStartAndEndBlocksEventFilter =
  TypedEventFilter<NewStartAndEndBlocksEvent>;

export type NewrewardPerSecondEvent = TypedEvent<
  [BigNumber],
  { rewardPerSecond: BigNumber }
>;

export type NewrewardPerSecondEventFilter =
  TypedEventFilter<NewrewardPerSecondEvent>;
...
export interface WAGStakingPoolInitializable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WAGStakingPoolInitializableInterface;
  ...
  functions: {
    ...
    SOUS_CHEF_FACTORY(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "NewrewardPerSecond(uint256)"(
      rewardPerSecond?: null
    ): NewrewardPerSecondEventFilter;
    NewrewardPerSecond(rewardPerSecond?: null): NewrewardPerSecondEventFilter;
  ...
  estimateGas: {
    ...
    SOUS_CHEF_FACTORY(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    SOUS_CHEF_FACTORY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
