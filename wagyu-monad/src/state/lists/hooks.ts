...
export function listToTokenMap(list: TokenList): TokenAddressMap {
  ...
  // Add Monad chain (143) if not exist
  if (!(MONAD_CHAIN_ID in tokenAddressMap)) {
    Object.defineProperty(tokenAddressMap, MONAD_CHAIN_ID, {
      value: {},
    })
  }
...
// Monad chainId (not in SDK ChainId enum)
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [MONAD_CHAIN_ID]: { ...map1[MONAD_CHAIN_ID], ...map2[MONAD_CHAIN_ID] },
  }
}
