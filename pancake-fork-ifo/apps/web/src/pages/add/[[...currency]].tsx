    ...
    <AddLiquidityV2FormProvider>
      <LiquidityFormProvider>
        <AddLiquidityV3Layout
          ...
          showRefreshButton={
            chainId === 143 ? false : preferFarmType?.type === SELECTOR_TYPE.V3 && preferFarmType?.feeAmount !== feeAmount
          }
        >
          <UniversalAddLiquidity
            ...
            preferredSelectType={
              chainId === 143 ? SELECTOR_TYPE.V2 : !feeAmount ? preferFarmType?.type : undefined
            }
