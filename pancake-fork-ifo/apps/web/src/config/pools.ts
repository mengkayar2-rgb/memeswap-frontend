...
export const POOLS_FAST_REVALIDATE = {
  ...
  [ChainId.OPEN_EX_LONG_TEST]: 10_000,
  [ChainId.MONAD]: 10_000,
...
export const POOLS_NORMAL_REVALIDATE = {
  ...
  [ChainId.OPEN_EX_LONG_TEST]: 15_000,
  [ChainId.MONAD]: 15_000,
} as const satisfies Record<ChainId, number>
...
export const POOLS_SLOW_REVALIDATE = {
  ...
  [ChainId.OPEN_EX_LONG_TEST]: 20_000,
  [ChainId.MONAD]: 20_000,
} as const satisfies Record<ChainId, number>
