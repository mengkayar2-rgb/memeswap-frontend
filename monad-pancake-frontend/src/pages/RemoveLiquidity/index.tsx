                    ...
                    <AutoColumn gap="10px">
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            <StyledInternalLink
                              to={`/remove/${currencyA === ETHER ? (WETH[chainId]?.address ?? '0xFfDFF1bAb47d8e6D1Da119F5C925fAC91FAfA899') : currencyIdA}/${
                                currencyB === ETHER ? (WETH[chainId]?.address ?? '0xFfDFF1bAb47d8e6D1Da119F5C925fAC91FAfA899') : currencyIdB
                              }`}
                            >
